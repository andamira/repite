...
mod tests {
    ...
    fn duration_ticks() {
        ...
        // 106_751_991_167_300d 15h30m7s999ms999µs999ns

        // dbg!(Duration::MAX.as_seconds_f64());
        // dbg!(Duration::MAX);
        // dbg!(Duration::MAX.as_seconds_f64() / u64::MAX as f64); // = 0.5 → ±i64s max?
        // dbg![i64::MAX];
        // dbg!(Duration::seconds_f64(i64::MAX as f64));
        //
        // let rdur = 500; // point of saturation for i64::MAX
        // let r = Rate::new(Duration::milliseconds(rdur));
        // let d = r.duration_ticks(u64::MAX);
        // println!("duration_dur:  {d} rate_dur: {rdur}ms\n");
        // dbg![i32::MAX as f64 / 1_000_000_000.];
    }

    #[test]
    fn instant_tick() {
        // PANICS
        // let r = Rate::new(Duration::milliseconds(500)); // 500 panics
        // dbg![r.instant_tick(u64::MAX)];

        // let r = Rate::new(Duration::seconds(i32::MAX as i64 + 2)); // +2 panics
        // dbg![r.instant_tick(u32::MAX as u64)];
    }
}
